...
ax[0].scatter(x[29:39], ctstar[index_mask][29:39], c=tab10(3*np.ones(9).astype(int), alpha=(10-np.arange(1,10)%10)/10), edgecolor='k')
...
ax[1].scatter(x[29:39], zeta[index_mask][29:39], c=tab10(3*np.ones(9).astype(int), alpha=(10-np.arange(1,10)%10)/10), edgecolor='k')
ax[1].set_ylim([0, 50])
...
plt.tight_layout()
plt.savefig('KirbyFigA1.png', bbox_inches='tight')
