...
ax[1].bar(np.arange(6), 1-tsl[index_mask], width=0.2, label=r'$1-\Pi_T$', color=tab20(0))
ax[1].bar(np.arange(6)+0.2, 1-fsl[index_mask], width=0.2, label=r'$1-\Pi_F$', color=tab20(2))
ax[1].set_ylim([0,1.2])
