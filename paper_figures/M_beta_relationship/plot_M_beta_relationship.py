...
ax[1].scatter(1-beta[43], M[43]-1, c='r', marker='P', zorder=1, label=r'Double turbine spacing')
ax[1].scatter(1-beta[41], M[41]-1, c='r', marker='x', zorder=1, label=r'Aligned turbine layout')
ax[1].scatter(1-beta[15], M[15]-1, c='r', marker='o', zorder=1, label=r'Staggered turbine layout')
print(case_id[15])
print(case_id[41])
