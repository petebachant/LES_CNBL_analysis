...
fig, ax = plt.subplots(ncols=2, figsize=[textwidth*cm,textwidth*cm/(2*1.1*golden_ratio)], dpi=300, layout='constrained')
...
ax[0].set_xlabel(r'Turbine-scale efficiency $\eta_{TS}$')
...
ax[1].set_xlabel(r'Farm-scale efficiency $\eta_{FS}$')
...
ax[1].text(0.05, 0.1, rf'$R^2={round(r_squared,3)}$', ha='left', va='center')
